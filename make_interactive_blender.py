...
for pan,tilt in [(0,0),(60,-30),(-60,-30),(25,-12)]:
    ...
    expected=Matrix.Translation((0,55,24)) @ Matrix.Rotation(math.radians(pan),4,'Z') @ Matrix.Translation((0,55,0)) @ Matrix.Rotation(math.radians(tilt),4,'X')
